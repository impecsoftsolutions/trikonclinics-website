...
-- 2. Open: https://supabase.com/dashboard/project/ztfrjlmkemqjbclaeqfw/sql/new
-- 3. Paste and click "Run"
-- 4. After successful execution, run: npm run events:seed
--
-- ============================================================
...
-- MIGRATION 2: Add Events Feature Flags
-- ============================================================
...
-- Only Super Admin can update site_settings
...
-- MIGRATION 3: Setup Events Storage Bucket
-- ============================================================
